...
组文件的集合称为一个{\bf 仓库}。GitHub是一个提供在线Git仓库
存储的服务商，其网络界面十分好用。
\index{repository}
\index{Git}
\index{GitHub}
...
大多数习题使用Python脚本，也有些使用IPython notebook。如果
你以前没用过IPython notebook，我建议你看看文档：
...
%TODO: check this figure reference
...
%TODO: replace the figures in this chapter
\begin{figure}
% diff_int.py
